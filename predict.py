...
def post_process(bboxes,obj_probs,class_probs,image_shape=(416,416),threshold=0.5):
...
def read_coco_labels():
    f = open("/home/chenwei/HDD/Project/YOLOv2-Tensorflow/yolo2_data/coco_classes.txt")
    class_names = []
...
def main():
    ...
    anchors = [[0.57273, 0.677385],
               ...
               [7.88282, 3.52778],
               [9.77052, 9.16828]]
    image_file = '/home/chenwei/HDD/Project/YOLOv2-Tensorflow/yolo2_data/car.jpg'
    ...
    logits = network.build_network(tf_image)
    output_sizes = input_size[0] // 32, input_size[1] // 32  # 特征图尺寸是图片下采样32倍
    output_decoded = network.decode(model_output=logits, output_sizes=output_sizes, num_class=80, anchors=anchors)

    model_path = "/home/chenwei/HDD/Project/YOLOv2-Tensorflow/yolo2_model/yolo2_coco.ckpt"
    ...
    bboxes,scores,class_max_index = post_process(bboxes,obj_probs,class_probs,image_shape=image_shape)
